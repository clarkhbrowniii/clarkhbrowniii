...
`AI` `Python` `Data` `Automation` `Enterprise Architecture`

Learning things, trying things, building things. Some of it will work.

Some of it will become a **valuable learning experience**. 😆
